...
tmp_rd.set('APPID',APPID)
tmp_rd.set('private_key',private_key)
tmp_rd.set('public_key',public_key)
tmp_rd.set('notify_url',notify_url)
tmp_rd.set('vip_price',vip_price)
tmp_rd.set('vip_password',vip_password)
